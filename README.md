...
从 [GitHub Releases](https://github.com/1256048998/DeepExcel/releases) 下载最新版本的 ZIP 包（如 `DeepExcel-v0.3.2.zip`）。
...
```powershell
python scripts\package_release.py --version 0.3.2
```

输出目录：`dist\DeepExcel-v0.3.2.zip`
