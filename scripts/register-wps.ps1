...
if ($Unregister) {
    ...
    $filesToCopy = @("main.js", "ribbon.xml", "jsplugins.xml", "taskpane.html", "package.json", "sidecar-host.js", "tool-dispatcher.js", "wps-actions.js", "range-paging.js", "jsa-executor.js", "config-store.js", "credential-store.js", "model-service.js", "dpapi-cli.py", "conversation-store.js", "attachment-store.js", "workbook-memory-store.js")
